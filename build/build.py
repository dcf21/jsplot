...
def makehtml():
    ...
    if minify:
        ...
        # cmd += " --source-map " + os.path.join(output, "js", "jsplot.min.map")
        cmd += " --output " + os.path.join(output, "js", "jsplot.min.js")
        print(cmd)
        os.system(cmd)
        for js in javascripts:
            os.unlink(js)
    else:
        cmd = "cat %s > %s"%(" ".join(javascripts),os.path.join(output, "js", "jsplot.min.js"))
        print(cmd)
        os.system(cmd)
